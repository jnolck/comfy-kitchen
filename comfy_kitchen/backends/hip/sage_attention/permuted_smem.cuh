...
struct smem_t
{
         ...
         */
        static __device__ __forceinline__ uint32_t get_permuted_offset(const uint32_t& i,
                                                                       const uint32_t& j)
        {
                if constexpr (swizzle_mode == SwizzleMode::k128B)
                {
        ...
        __device__ __forceinline__ void load_128b_async(const uint32_t& offset, const T* gptr,
